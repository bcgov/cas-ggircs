...
comment on column ciip.application.application_year is 'The reporting year of GHG emissions the application is for';
comment on column ciip.application.application_type is 'The type of application, either SFO or LFO';
