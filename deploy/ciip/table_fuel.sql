...
create index ciip_fuel_facility_foreign_key on ciip.fuel(facility_id);
create index ciip_fuel_operator_foreign_key on ciip.fuel(operator_id);
...
comment on column ciip.fuel.facility_id         is 'The facility id';
comment on column ciip.fuel.operator_id         is 'The operator id';
