...
INSERT INTO ggircs_swrs.fuel_mapping (fuel_type, normalized_fuel_type, state, carbon_taxed, cta_mapping, cta_rate_units) VALUES ('Concentrated Non-Condensable Gases', 'CNCGs (Sm^3)', '(Gas)', 'no', 'n/a', '$/tonne');
...
INSERT INTO ggircs_swrs.fuel_mapping (fuel_type, normalized_fuel_type, state, carbon_taxed, cta_mapping, cta_rate_units) VALUES ('Lubricants', 'Lubricants (kilolitres)', '(Liquid)', 'no', 'n/a', '$/litre');
...
INSERT INTO ggircs_swrs.fuel_mapping (fuel_type, normalized_fuel_type, state, carbon_taxed, cta_mapping, cta_rate_units) VALUES ('Municipal Solid Waste - biomass component', 'Municipal Solid Waste - biomass component (bone dry tonnes)', '(Solid)', 'no', 'n/a', '$/tonne');
