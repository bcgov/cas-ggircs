...
\copy ggircs_swrs.fuel_mapping(fuel_type, n_fuel_type,state, carbon_taxed, cta_mapping, cta_rate_30_tCO2e, cta_rate_35_tCO2e, cta_rate_40_tCO2e, cta_rate_45_tCO2e, cta_rate_50_tCO2e, cta_rate_units) from './test/fixture/fuel_mapping.csv' with (format csv);
