...
copy ggircs_swrs.fuel_mapping(fuel_type, n_fuel_type,state, carbon_taxed, cta_mapping, co2e_conversion_rate, cta_rate_units) from '/home/dleard/Button/cas-ggircs/data/fuel_mapping_remix.csv' with (format csv);
