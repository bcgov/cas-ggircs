  ...
  from x,
       xmltable(
           ...
           columns
             ...
             annual_fuel_amount numeric path './AnnualFuelAmount',
             annual_weighted_avg_carbon_content numeric path './AnnualWeightedAverageCarbonContent',
             annual_weighted_avg_hhv numeric path './AnnualWeightedAverageHighHeatingValue',
             annual_steam_generation numeric path './AnnualSteamGeneration',
