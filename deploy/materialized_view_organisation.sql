...
create unique index ggircs_organization_primary_key on ggircs_swrs.organisation (id);
create index ggircs_organization_history on ggircs_swrs.organisation (swrs_organisation_history_id);
