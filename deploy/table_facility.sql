...
create table ggircs.facility (
    ...
    parent_facility_id        integer references ggircs.facility(id) deferrable initially immediate ,
...
create index ggircs_facility_organisation_foreign_key on ggircs.facility(organisation_id);
create index ggircs_facility_report_foreign_key on ggircs.facility(report_id);
create index ggircs_parent_facility_id_foreign_key on ggircs.facility(parent_facility_id);
...
comment on column ggircs.facility.parent_facility_id is 'A foreign key reference to ggircs.lfo_facility';
