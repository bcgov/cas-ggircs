...
comment on table ggircs_swrs.activity is 'The materialized view for Activity and Subactivity from each report';
...
comment on column ggircs_swrs.activity.swim_report_id is 'the report id extracted from the actual report that came from SWRS';
...
comment on column ggircs_swrs.activity.swim_report_history_id is 'The history id of the report this was pulled from (redundant)';
