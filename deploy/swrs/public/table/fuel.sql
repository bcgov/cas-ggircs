...
create table ggircs.fuel (
    ...
    fuel_mapping_id                     integer references ggircs.fuel_mapping(id),
...
comment on column ggircs.fuel.fuel_mapping_id is 'A foreign key reference to ggircs.fuel_mapping';
