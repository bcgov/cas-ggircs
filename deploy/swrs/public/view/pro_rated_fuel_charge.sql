...
--     ), y as (select year, ctd_id, fuel_mapping_id, fuel_type, year_length, duration, fuel_charge, unit_conversion_factor,
...
--                       and _fuel_charge.fuel_carbon_tax_details_id = x.ctd_id
--                    ) as flat_rate,
--              case when year <= 2017
--                  then
...
--                            from swrs.fuel_charge as _fuel_charge
--                            where _fuel_charge.fuel_carbon_tax_details_id = x.ctd_id)
--                        )
...
--             from x where duration > 0 group by fuel_mapping_id, year,fuel_type, year_length, fuel_charge, duration, unit_conversion_factor, ctd_id)
--             select
--                    fuel_mapping_id,
--                    fuel_type,
--                    year,
