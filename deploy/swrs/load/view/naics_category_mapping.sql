...
create or replace view ggircs_swrs_load.naics_category_mapping as
    with distinct_naics_code_list as (
        ...
        from ggircs_swrs_load.naics
                 join ggircs_swrs_load.naics_naics_category as _nnc
                      on naics_code::text like naics_code_pattern || '%'
                 left join ggircs_swrs_load.naics_category as _naics_category
                           on _nnc.category_id = _naics_category.id
                 left join ggircs_swrs_load.naics_category_type as _naics_category_type
      ...
      from ggircs_swrs_load.naics
        ...
        join ggircs_swrs_load.facility as _facility
