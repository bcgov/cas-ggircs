...
create or replace view ggircs_swrs_load.pro_rated_fuel_charge as
    with x as (
        ...
        from ggircs_swrs_load.fuel
                 ...
                 join ggircs_swrs_load.emission as _emission
            ...
            (select _fuel_charge.fuel_charge * x.unit_conversion_factor
                      from ggircs_swrs_load.fuel_charge as _fuel_charge
             ...
             case when year <= 2017
                 then
                    (select distinct(fuel_charge) * unit_conversion_factor
                       from ggircs_swrs_load.fuel_charge
                       where id = (
