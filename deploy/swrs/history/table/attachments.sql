...
(
    ...
    report_id                 integer references swrs_history.report(id),
...
create index attachment_report_fkey on swrs_history.report_attachment(report_id);
...
comment on column swrs_history.report_attachment.report_id is 'The foreign key to the report this attachment belongs to';
