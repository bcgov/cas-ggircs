...
create unique index ggircs_naics_primary_key on swrs_transform.naics (ghgr_import_id, swrs_facility_id, path_context, naics_code_idx);
...
comment on column swrs_transform.naics.ghgr_import_id is 'The foreign key reference to swrs_extract.ghgr_import.id';
