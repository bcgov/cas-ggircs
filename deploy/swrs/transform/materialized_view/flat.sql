...
create unique index ggircs_flat_primary_key on swrs_transform.flat (ghgr_import_id, element_id);
create index ggircs_flat_report on swrs_transform.flat (ghgr_import_id);
...
comment on column swrs_transform.flat.ghgr_import_id is 'The foreign key reference to swrs_extract.ghgr_import.id';
