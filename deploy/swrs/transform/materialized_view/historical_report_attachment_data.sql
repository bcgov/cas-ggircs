...
comment on column swrs_transform.historical_report_attachment_data.uploaded_file_name is 'The name of the user who uploaded the attachment file';
comment on column swrs_transform.historical_report_attachment_data.uploaded_file_name is 'The date of upload';
