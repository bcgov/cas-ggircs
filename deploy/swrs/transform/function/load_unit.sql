...
create or replace function ggircs_swrs_transform.load_unit()
  returns void as
$function$
    begin

        delete from ggircs_swrs_load.unit;
        insert into ggircs_swrs_load.unit (id, ghgr_import_id, activity_id, activity_name, unit_name, unit_description, cogen_unit_name, cogen_cycle_type, cogen_nameplate_capacity,
        ...
        from ggircs_swrs_transform.unit as _unit

        inner join ggircs_swrs_transform.final_report as _final_report on _unit.ghgr_import_id = _final_report.ghgr_import_id
