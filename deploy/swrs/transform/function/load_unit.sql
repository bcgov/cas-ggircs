...
$function$
    begin
        ...
        insert into swrs_load.unit (id, ghgr_import_id, activity_id, activity_name, unit_name, unit_description, cogen_unit_name, cogen_cycle_type, cogen_nameplate_capacity,
        ...
        inner join swrs_transform.final_report as _final_report on _unit.ghgr_import_id = _final_report.ghgr_import_id
