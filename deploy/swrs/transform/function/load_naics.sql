...
$function$
    begin
        ...
        insert into swrs_load.naics(id, eccc_xml_file_id, facility_id,  registration_data_facility_id, report_id, swrs_facility_id, path_context, naics_classification, naics_code, naics_priority)

        select _naics.id, _naics.eccc_xml_file_id, _facility.id,
        ...
        inner join swrs_transform.final_report as _final_report on _naics.eccc_xml_file_id = _final_report.eccc_xml_file_id
        -- FK Naics ->  Facility
        left join swrs_transform.facility as _facility
          on _naics.eccc_xml_file_id = _facility.eccc_xml_file_id
        -- FK Naics -> Report
        left join swrs_transform.report as _report
          on _naics.eccc_xml_file_id = _report.eccc_xml_file_id;
