...
create or replace function ggircs_swrs_transform.load_parent_organisation()
  returns void as
$function$
    begin

        delete from ggircs_swrs_load.parent_organisation;
        insert into ggircs_swrs_load.parent_organisation (id, ghgr_import_id, report_id, organisation_id, path_context, percentage_owned, french_trade_name, english_trade_name,
        ...
        from ggircs_swrs_transform.parent_organisation as _parent_organisation

        inner join ggircs_swrs_transform.final_report as _final_report on _parent_organisation.ghgr_import_id = _final_report.ghgr_import_id
