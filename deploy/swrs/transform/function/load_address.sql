...
$function$
    begin
        ...
        insert into swrs_load.address (id, eccc_xml_file_id, facility_id,  organisation_id, parent_organisation_id, report_id, swrs_facility_id, swrs_organisation_id, path_context, type, physical_address_municipality, physical_address_unit_number,
        ...
        select _address.id, _address.eccc_xml_file_id, _facility.id,  _organisation.id, _parent_organisation.id, _report.id, _address.swrs_facility_id, _address.swrs_organisation_id,
        ...
        inner join swrs_transform.final_report as _final_report on _address.eccc_xml_file_id = _final_report.eccc_xml_file_id
        -- FK Address -> Facility
        left join swrs_transform.facility as _facility
            on _address.eccc_xml_file_id = _facility.eccc_xml_file_id
        --FK Address -> Organisation
        left join swrs_transform.organisation as _organisation
          on _address.eccc_xml_file_id = _organisation.eccc_xml_file_id
        ...
        left join swrs_transform.parent_organisation as _parent_organisation
          on _address.eccc_xml_file_id = _parent_organisation.eccc_xml_file_id
        ...
        left join swrs_transform.report as _report
          on _address.eccc_xml_file_id = _report.eccc_xml_file_id;
