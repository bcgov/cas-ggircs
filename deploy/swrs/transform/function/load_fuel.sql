...
$function$
    begin
        ...
        insert into swrs_load.fuel(id, ghgr_import_id, report_id, unit_id, fuel_mapping_id,
        ...
        inner join swrs_transform.final_report as _final_report on _fuel.ghgr_import_id = _final_report.ghgr_import_id
        -- FK Fuel -> Report
