...
create or replace function ggircs_swrs_transform.load_emission()
  returns void as
$function$
    begin

        delete from ggircs_swrs_load.emission;
        insert into ggircs_swrs_load.emission (id, ghgr_import_id, activity_id, facility_id,  fuel_id, naics_id, organisation_id, report_id, unit_id, activity_name, sub_activity_name,
        ...
        from ggircs_swrs_transform.emission as _emission
        -- join ggircs_swrs_transform.emission to use _idx columns in FK creations
        inner join ggircs_swrs_transform.final_report as _final_report on _emission.ghgr_import_id = _final_report.ghgr_import_id
        ...
        -- FK Emission -> Fuel
        left join ggircs_swrs_transform.fuel as _fuel
        ...
        left outer join ggircs_swrs_transform.naics as _naics
          ...
          and (select count(ghgr_import_id)
               from ggircs_swrs_transform.naics as __naics
