...
$function$
    begin
        ...
        insert into swrs_load.fuel_carbon_tax_details (normalized_fuel_type, state, carbon_tax_act_fuel_type_id, cta_rate_units, unit_conversion_factor) values ('Flared Natural Gas CH4','Gas',13,'$/m3',1000000/6.5);     -- deprecated row, not used to calculate carbon tax
        insert into swrs_load.fuel_carbon_tax_details (normalized_fuel_type, state, carbon_tax_act_fuel_type_id, cta_rate_units, unit_conversion_factor) values ('Flared Natural Gas N20','Gas',13,'$/m3',1000000/0.06);    -- deprecated row, not used to calculate carbon tax
        insert into swrs_load.fuel_carbon_tax_details (normalized_fuel_type, state, carbon_tax_act_fuel_type_id, cta_rate_units, unit_conversion_factor) values ('Vented Natural Gas','Gas',13,'$/m3',1000000/678.5);       -- unit_conversion_factor as per WCI.353 Equations 350-9 &  360-20
