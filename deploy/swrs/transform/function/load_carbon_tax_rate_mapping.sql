...
$function$
    begin
        ...
        insert into swrs_load.carbon_tax_rate_mapping(rate_start_date, rate_end_date, carbon_tax_rate) values ('2020-04-01', '2021-03-31', 45);
        insert into swrs_load.carbon_tax_rate_mapping(rate_start_date, rate_end_date, carbon_tax_rate) values ('2021-04-01', '9999-03-31', 50);
    end
