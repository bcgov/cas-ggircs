...
create or replace function ggircs_swrs_transform.load_measured_emission_factor()
  returns void as
$function$
    begin

        delete from ggircs_swrs_load.measured_emission_factor;
        insert into ggircs_swrs_load.measured_emission_factor (id, ghgr_import_id, fuel_id,
        ...
        from ggircs_swrs_transform.measured_emission_factor as _measured_emission_factor

        inner join ggircs_swrs_transform.final_report as _final_report on _measured_emission_factor.ghgr_import_id = _final_report.ghgr_import_id
