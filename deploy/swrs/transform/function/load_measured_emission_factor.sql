...
$function$
    begin
        ...
        insert into swrs_load.measured_emission_factor (id, ghgr_import_id, fuel_id,
        ...
        inner join swrs_transform.final_report as _final_report on _measured_emission_factor.ghgr_import_id = _final_report.ghgr_import_id
