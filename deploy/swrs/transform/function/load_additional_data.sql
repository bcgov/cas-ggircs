...
$function$
    begin
        ...
        insert into swrs_load.additional_data (id, ghgr_import_id, activity_id, report_id,
        ...
        inner join swrs_transform.final_report as _final_report on _additional_data.ghgr_import_id = _final_report.ghgr_import_id
