...
-- Test table raw_report exists in schema ggircs_private
...
select col_type_is('ggircs_private', 'raw_report', 'xml_file', 'xml', 'Column xml_file has type xml');
select col_type_is('ggircs_private', 'raw_report', 'imported_at', 'timestamp with time zone', 'Column imported_at has type timestamp with timezone');

-- Test NOT NULL columns have constraint
select col_not_null('ggircs_private', 'raw_report', 'xml_file', 'Column xml_file has NOT NULL constraint');
select col_not_null('ggircs_private', 'raw_report', 'imported_at', 'Column imported_at has NOT NULL constraint');
