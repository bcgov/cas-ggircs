...
select has_column('ggircs_swrs', 'facility', 'ghgr_id', 'ggircs_swrs.facility has column: ghgr_id');
...
select col_type_is('ggircs_swrs', 'facility', 'ghgr_id', 'integer', 'ggircs_swrs.facility column _ghgr_id has type integer');
...
select results_eq('select ghgr_id from ggircs_swrs.facility', ARRAY[1::integer], 'ggircs_swrs.facility parsed column ghgr_id');
