...
-- Facility
    insert into ggircs.single_facility (id, ghgr_import_id, organisation_id, report_id, swrs_facility_id, facility_name, facility_type, relationship_type, portability_indicator, status, latitude, longitude)
...
-- NAICS
insert into ggircs.naics(id, ghgr_import_id, single_facility_id, registration_data_single_facility_id, report_id, swrs_facility_id, path_context, naics_classification, naics_code, naics_priority)

    select _naics.id, _naics.ghgr_import_id, _single_facility.id,
...
select results_eq(
  ...
  $$
    select
       ...
       n.report_id,
       fc.organisation_id,
       n.single_facility_id,
       r.swrs_report_id,
       r.swrs_organisation_id,
       r.swrs_facility_id
    from ggircs.naics as n
        join ggircs.single_facility as fc
        on n.single_facility_id = fc.id
