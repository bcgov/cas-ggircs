...
select col_type_is( 'swrs_utility', 'fuel_mapping', 'fuel_carbon_tax_detail_id', 'integer', 'fuel_mapping.fuel_carbon_tax_details_id column should be type integer');
select col_hasnt_default('swrs_utility', 'fuel_mapping', 'fuel_carbon_tax_detail_id', 'fuel_mapping.fuel_carbon_tax_details_id column should not have a default value');
