-- Deploy ggircs-app:functions/session to pg

begin;

create or replace function ggircs_app.session()
    returns ggircs_app.jwt_token as
$function$
declare
...
begin
  ...
  return (
    ...
    )::ggircs_app.jwt_token
  );
end
$function$ language 'plpgsql' stable;

grant execute on function ggircs_app.session to ggircs_user, ggircs_guest;
