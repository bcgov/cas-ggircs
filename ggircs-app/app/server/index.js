...
app.prepare().then(async () => {
  ...
  const ggircsParametersSchema = process.env.GGIRCS_PARAMETERS_SCHEMA || "ggircs_parameters";

  server.use(
    postgraphile(
      dbPool,
      [ggircsAppSchema, swrsHistorySchema, swrsExtractSchema, ggircsParametersSchema],
      {
        ...postgraphileOptions(),
        pgSettings: (req) => {
          const opts = {
