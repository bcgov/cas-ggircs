...
function RequestAccessNotice({
  preloadedQuery,
}: RelayProps<{}, requestAccessNoticeQuery>) {
  ...
  return (
    <DefaultLayout session={query.session}>
      ...
      <p>
        This application has restricted access. Please contact an administrator
        to gain access
      </p>
    </DefaultLayout>
  );
